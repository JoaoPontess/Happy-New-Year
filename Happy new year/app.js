...
const timeline = new mojs.Timeline({
    ...
    // Animação de transição de ano
    const currentYear = document.getElementById("current-year");
    const newYear = document.getElementById("new-year");
    const transitionText = document.getElementById("transition-text");

    // Aguarda 2 segundos e, em seguida, mostra a transição de ano
    setTimeout(() => {
        currentYear.classList.add("show");
        transitionText.classList.add("show");

        // Aguarda mais 1 segundo e inicia a transição para 2024
        setTimeout(() => {
            currentYear.classList.remove("show");
